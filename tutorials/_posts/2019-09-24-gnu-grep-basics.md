...
يحتوي GNU Grep على مجموعتين من ميزات التعبير النمطي: Basic and Extended.

في التعبيرات النمطية الأساسية ، تفقد الأحرف الوصفية ؟ و + و { و | و ( و ) معناها الخاص (الذي يرد وصف لاستخداماته لاحقًا في هذه المقالة). وكما هو مذكور أدناه ، للتبديل إلى استخدام التعبيرات النمطية الموسعة تحتاج إلى إضافة الخيار -E إلى الأمر grep.
