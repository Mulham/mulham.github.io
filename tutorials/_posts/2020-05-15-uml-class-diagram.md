...
**نصيحة:** لإنشاء مخطط UML على الحاسوب بشكل عملي فهناك العديد من تكبيقات الوب التي تعمل على المتصفح وتساعدك في ذلك مثل أداة [Creately](https://creately.com/lp/uml-diagram-tool/) المجانية، ولكنها فقط للمخططات الصغيرة المؤلفة من ثلاث أصناف تقريبًا.. للمخططات الكبيرة يفضل استخدام تطبيق على الحاسوب وأنصحك بـ [Eclipse Papyrus](https://www.eclipse.org/papyrus/download.html) المجاني.
