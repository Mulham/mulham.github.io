...
{% include image.html layout="responsive" width="325" height="263" src="/assets/articles/mmix1.png" alt="تمارين عملية في برنامج mmix" %}
...
{% include image.html layout="responsive" width="300" height="333" src="/assets/articles/bubble-sort.png" alt="خوارزمية ترتيب الأعداد bubble sort" %}
