<?php
	...
	$encryption_key		= '0966712486';			// Unique 8 to 32 character encryption key
	$notification_email	= 'mulham94@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'Mulham';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'letmein94';			// Password to gain admin rights
