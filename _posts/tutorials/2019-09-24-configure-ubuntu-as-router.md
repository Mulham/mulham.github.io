...
image:
  path: /assets/posts/ubuntu-router.jpg
  alt: "Ubuntu by davidjunyent is licensed under CC BY-NC-ND 2.0"
---
...
![Ubuntu as a router - Configuration of eth0](/assets/ubuntu-as-router2.jpg)

![Setting up network on eth0](/assets/ubuntu-as-router3.jpg)

![Setting up network on eth 1](/assets/ubuntu-as-router4.jpg)

![Ubuntu as a router - Configuration of eth0](/assets/ubuntu-as-router5.jpg)
