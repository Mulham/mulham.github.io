...
**تحديث**: توفر حاليًا مؤسسة Yunus Emre منهاج تفاعلي متكامل لتعلم اللغة التركية من المستوى الأول A1 وحتى المتقدم C1 على الموقع [هنا](https://learnturkish.com/doys/Login/Index#!Home/Index). قم بإنشاء حساب وابدأ التعلم مجانًا.
{: .notice}
